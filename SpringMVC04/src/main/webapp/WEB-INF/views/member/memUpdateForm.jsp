				...
				<form name="frm" action="${contextPath}/memUpdate.do" method="post" >
					<table class="table table-bordered"
						...
						<tr>
							...
							<td colspan="2">
								<input id="memPassword"  name = "memPassword" type="hidden" value="${mvo.memPassword}"/>
								<input id="memPassword1" name = "memPassword1"
								class="form-control" type="password" maxlength="20"
								placeholder="비밀번호를 입력하세요" onkeyup = "check_pwd()"  value="${mvo.memPassword}" />
							</td>
						...
						<tr>
							...
							<td colspan="2"><input id="memPassword2" name="memPassword2"
								class="form-control" type="password" maxlength="20"
								placeholder="비밀번호를 확인하세요" onkeyup = "check_pwd()" value="${mvo.memPassword}" /></td>
